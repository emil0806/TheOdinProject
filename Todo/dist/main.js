...
(self["webpackChunktodo"] = self["webpackChunktodo"] || []).push([
  ...
  \**********************/
      /***/ (
        ...
        /* harmony import */ var _modules_renderPage_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./modules/renderPage.js */ "./src/modules/renderPage.js"
          );
        /* harmony import */ var _modules_createTodo_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./modules/createTodo.js */ "./src/modules/createTodo.js"
          );
        /* harmony import */ var _modules_createProject_js__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./modules/createProject.js */ "./src/modules/createProject.js"
          );
        /* harmony import */ var _modules_renderTodo_js__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./modules/renderTodo.js */ "./src/modules/renderTodo.js"
          );
        /* harmony import */ var _modules_storage_js__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! ./modules/storage.js */ "./src/modules/storage.js"
          );
        /* harmony import */ var _modules_renderProjects__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(
            /*! ./modules/renderProjects */ "./src/modules/renderProjects.js"
          );
        ...
        const createDefaultProject = (() => {
          ...
          (0,
          _modules_createProject_js__WEBPACK_IMPORTED_MODULE_2__.createProjects)();
          (0,
          _modules_renderProjects__WEBPACK_IMPORTED_MODULE_5__.renderProjectList)();
        })();
  ...
  \**************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ createProjects: () =>
            /* binding */ createProjects,
          /* harmony export */ projectFactory: () =>
            /* binding */ projectFactory,
          /* harmony export */ projectObjectList: () =>
            /* binding */ projectObjectList,
        ...
        const projectFactory = (title) => {
          ...
          const removeProjectFromList = (project) => {
            _storage_js__WEBPACK_IMPORTED_MODULE_0__.projectList.splice(
              _storage_js__WEBPACK_IMPORTED_MODULE_0__.projectList.indexOf(
                project
              ),
              1
            );
        ...
        function createProjects() {
          ...
          _storage_js__WEBPACK_IMPORTED_MODULE_0__.storeProjects.projectList.forEach(
            (project) => {
  ...
  \***********************************/
      /***/ (
        ...
        function createTodos() {
          _createProject__WEBPACK_IMPORTED_MODULE_0__.projectObjectList.forEach(
            (project) => {
  ...
  \***************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ renderProjectList: () =>
            /* binding */ renderProjectList,
          /* harmony export */
        });
        /* harmony import */ var _createProject__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
        ...
        /* harmony import */ var _storage_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./storage.js */ "./src/modules/storage.js");
        /* harmony import */ var _createTodo__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./createTodo */ "./src/modules/createTodo.js"
          );
        /* harmony import */ var _renderTodo__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./renderTodo */ "./src/modules/renderTodo.js"
          );
        ...
        const renderProject = (project) => {
          ...
          projectRemoveBtn.addEventListener("click", (e) => {
            ...
            removeProjectCheckYes.addEventListener("click", (e) => {
              ...
              (0, _createProject__WEBPACK_IMPORTED_MODULE_0__.removeProject)(
                project
              );
              _storage_js__WEBPACK_IMPORTED_MODULE_1__.storeProjects.removeProjectFromList(
                project
              );
              pageOverlay.remove();
              projectDiv.remove();
          ...
          projectDiv.addEventListener("click", (e) => {
            ...
            (0, _renderTodo__WEBPACK_IMPORTED_MODULE_3__.renderToDoObjects)(
              project
            );
          });
        };
        ...
        const renderProjectCreateBtn = (() => {
          ...
          projectCreateBtnContainer.setAttribute(
            "id",
            "projectCreateBtnContainer"
          );
          ...
          projectCreateBtn.addEventListener("click", (e) => {
            ...
            projectSubmitBtn.addEventListener("click", (e) => {
              if (
                _storage_js__WEBPACK_IMPORTED_MODULE_1__.projectList.includes(
                ...
                _storage_js__WEBPACK_IMPORTED_MODULE_1__.storeProjects.addProjectToList(
                  projectTitleInput.value
                );
                (0,
                _createProject__WEBPACK_IMPORTED_MODULE_0__.createProjects)();
          ...
          projectCreateBtnContainer.append(projectCreateBtn);
          projects.insertAdjacentElement(
            "afterbegin",
            projectCreateBtnContainer
          );
        })();
  ...
  \***********************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ renderToDoObjects: () =>
            /* binding */ renderToDoObjects,
          /* harmony export */
        });
        ...
        const renderToDoObjects = (project) => {
          ...
          if (project.projectTodoList.length > 0) {
            project.projectTodoList.forEach((i) => {
              ...
              todoRemoveBtn.addEventListener("click", (e) => {
                ...
                _storage_js__WEBPACK_IMPORTED_MODULE_1__.storeTodos.setTodoList(
                  project
                );
                localStorage.removeItem(
                  project.title + " " + i.title + " todo info",
                ...
                todoSubmitBtn.addEventListener("click", (e) => {
                  if (todoTitleInput.value == "") {
                    ...
                    const todoTitleInput =
                      document.querySelector(".todoTitleInput");

                    const editedTodo = (0,
                    _createTodo__WEBPACK_IMPORTED_MODULE_0__.todoFactory)(
          ...
          todoCreateBtnContainer.setAttribute(
            "class",
            "todoCreateBtnContainer"
          );
